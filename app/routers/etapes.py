...
@router.get(ETAPES_PATH, response_description="Get etapes", response_model=List[EtapaModel])
...
@router.post(ETAPES_PATH, response_description="Add new Etapa", response_model=EtapaModel)
async def create_etapa(my_input: EtapaModel = Body(...)):
...
@router.get(SPECIFIC_ETAPA_PATH, response_description="Get etapa by id", response_model=EtapaModel)
